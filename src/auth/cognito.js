...
// We'll use our authorize middleware
...
module.exports.strategy = () =>
  ...
  new BearerStrategy(async (token, done) => {
    try {
      ...
      logger.error({ errorName: err?.name }, 'could not verify token');
      done(null, false);
    }
  });

// Delegate authorization to our custom middleware
