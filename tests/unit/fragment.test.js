...
describe('Fragment class', () => {
  ...
  describe('isSupportedType()', () => {
    ...
    test('text and JSON types are supported', () => {
      expect(Fragment.isSupportedType('text/plain')).toBe(true);
    ...
    test('supported image types are accepted and unsupported binary, audio, and video types are rejected', () => {
  ...
  describe('formats', () => {
    ...
    test('formats returns Markdown and HTML for Markdown fragments', () => {
      const fragment = new Fragment({
        ownerId: '1234',
        type: 'text/markdown',
        size: 0,
    ...
    test('formats returns JSON for JSON fragments', () => {
      const fragment = new Fragment({
        ownerId: '1234',
